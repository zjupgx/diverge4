...
// New function for gap-weighted divergence calculation
bool
type_two_divergence_with_gaps(const Tree &t1, const Tree &t2, 
                             const vector<sequence_t> &original_sequences,
                             const double alpha, const vector<double> &tree1_numsub,
                             const vector<double> &tree2_numsub, 
                             const vector<int> &kept_positions,
                             vector<double> &summary, vector<double> &rets);
...
void debug_gap_analysis(const vector<sequence_t> &original_sequences, 
                       const vector<int> &kept_positions);
...
enum SITE_CLASSIFY amino_acid_compare(char a, char b) {
	...
	// Default case (should not reach here in normal circumstances)
		return DIFFGROUP;
}
//----------------------------------------------------------------------
